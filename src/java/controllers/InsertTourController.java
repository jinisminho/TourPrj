...
public class InsertTourController extends HttpServlet {
    ...
    static private final String INVALID = "insertTour.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (e.getMessage().contains("Violation of PRIMARY KEY")) {
                errorObj.setTourIdErr("Tour ID is duplicated");
                request.setAttribute("INVALID", errorObj);
                url = INVALID;
            } else {
                request.setAttribute("ERROR", "ERROR at InsertTourController: " + e.getMessage());
